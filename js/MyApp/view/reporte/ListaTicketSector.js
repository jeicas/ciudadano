Ext.define('MyApp.view.reporte.ListaTicketSector', {
    extend: 'Ext.grid.Panel', 
    alias: 'widget.listaTicketSector',
    itemId: 'listaTicketSector',
    requires: [
        'Ext.selection.CellModel',        
        'Ext.grid.column.Action',
        'Ext.grid.column.Column'
    ],
    store       : Ext.create('MyApp.store.reporte.ReporteSectorStore'),
